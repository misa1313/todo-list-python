...
connection_string = f"postgresql+asyncpg://{user}:{password}@postgres:5432/{database}"
test_connection_string = (
    f"postgresql+asyncpg://{test_user}:{test_password}@postgres-test:5433/{test_database}"
)
